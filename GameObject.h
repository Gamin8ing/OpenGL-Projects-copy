...
public:
  ...
  GameObject(GLchar l_type, GLfloat l_colliderRadius, glm::vec3 l_startLocation,
             glm::vec3 l_looking_dir_vec, GLfloat l_movementSpeed) {
    this->type = l_type;
  ...
  void incrementPosition() {
    this->location += (glm::vec3(this->movementSpeed, this->movementSpeed, 0) *
                       this->look_at);
  }
};
